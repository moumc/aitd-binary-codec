module.exports = {
  ...
  overrides: [
    ...
    {
      files: ['src/AITD/default-aitd-client.ts'],
      rules: {
        // This is actually a good rule to have enabled, but for the AITDClient, we define a helper error message class in the same file
        'max-classes-per-file': 'off',
      },
    },
  ],
